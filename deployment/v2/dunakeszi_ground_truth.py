...
MANEUVER_SEGMENTS: List[Dict[str, Any]] = [
    ...
    {"id": 1,  "session": "show_1",  "within_session_offset_s": 123,
     ...
     "mems_available": False, "quality_flags": []},
    ...
    {"id": 16, "session": "show_7",  "within_session_offset_s": 0,
     ...
     "mems_available": True, "quality_flags": []},
    ...
    {"id": 22, "session": "show_9",  "within_session_offset_s": 0,
     ...
     "mems_available": True,
     "quality_flags": ["start_z_approx_5m_not_0", "execution_order_1_of_4"]},
    ...
    {"id": 25, "session": "show_9",  "within_session_offset_s": 72,
     ...
     "start_coord": [60, 60, 5], "end_coord": [-60, -60, 120], "duration_s": 69,
     "mems_available": True,
     "quality_flags": ["start_z_approx_5m_not_0", "execution_order_2_of_4"]},
    ...
    {"id": 23, "session": "show_9",  "within_session_offset_s": 144,
     ...
     "start_coord": [-60, 60, 5], "end_coord": [60, -60, 120], "duration_s": 69,
     "mems_available": True,
     "quality_flags": ["start_z_approx_5m_not_0", "execution_order_3_of_4"]},
    ...
    {"id": 24, "session": "show_9",  "within_session_offset_s": 216,
     ...
     "start_coord": [60, -60, 5], "end_coord": [-60, 60, 120], "duration_s": 69,
     "mems_available": True,
     "quality_flags": ["start_z_approx_5m_not_0", "execution_order_4_of_4"]},
    ...
    {"id": 30, "session": "show_12", "within_session_offset_s": 0,
     ...
     "start_coord": [-2.5, 0, 20], "end_coord": None, "duration_s": 8,
     "mems_available": True,
     "quality_flags": ["radius_adjusted_from_5m_to_10m", "short_segment"]},
    ...
    {"id": 36, "session": "show_14", "within_session_offset_s": 0,
     ...
     "start_coord": [-2.5, 0, 20], "end_coord": None, "duration_s": 8,
     "mems_available": True,
     "quality_flags": ["short_segment", "drone132_log_id_shared_with_show_13"]},
    ...
    {"id": 37, "session": "show_14", "within_session_offset_s": 11,
     ...
     "start_coord": [-2.5, 0, 20], "end_coord": None, "duration_s": 47,
     "mems_available": True,
     "quality_flags": ["drone132_log_id_shared_with_show_13"]},
    ...
    {"id": 39, "session": "show_15", "within_session_offset_s": 0,
     ...
     "mems_available": True,
     "quality_flags": ["v_formation_not_always_maintained"]},
    ...
    {"id": 41, "session": "show_10", "within_session_offset_s": 0,
     ...
     "duration_s":  188,
     "mems_available": True,
     "quality_flags": ["manual_flight", "no_show_file", "audible_to_200m_on_BK6E"]},
]
...
def build_file_index(segments: list) -> dict:
    ...
    mems_start  = MEMS_START_LOCAL_S - RECORDING_REF_LOCAL_S  # onset from rec

    mems_index: Dict[str, List[int]] = {}
    for i, fname in enumerate(MEMS_FILES):
        chunk_start = mems_start + i * mems_dur
...
_CSV_COLS = [
    ...
    "mems_available", "quality_flags", "gpx_folder",
]
